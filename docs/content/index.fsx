...
<div class="row">
  ...
  <div class="span6">
    <div class="well well-small" id="nuget">
      The F# ProjectTemplate library can be <a href="https://nuget.org/packages/SqlServer.Management.IntegrationServices">installed from NuGet</a>:
      <pre>PM> Install-Package SqlServer.Management.IntegrationServices</pre>
    </div>
  </div>
  <div class="span1"></div>
</div>
