...
let project = "SqlServer.Management.IntegrationServices"
...
let description = "SQL Server Integration Services management library for executing and working with SSIS packages. The library makes use of the SSIS catalog stored procedures."
